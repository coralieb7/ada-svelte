...
<div class="max-w-md mx-auto p-6 bg-gray-50 border-2 border-violet-700 rounded-lg shadow-md">
  <h2 class="text-xl font-bold mb-4">Top-5 Genres - Male directors</h2>
  ...
  {#if verificationResult}
    <p 
        class="
            mt-4 
            text-center 
            {verificationResult.includes('Congrats') ? 'text-emerald-500' : 'text-violet-600'}
        "
    >
        {verificationResult}
    </p>
